...
TForm1 *Form1;
  ...
  //p1..p25 pola w grze (ich zawartosc: p1='n'; nic lub 'x' lub 'o' )
  char kto;
 ...
 void sprawdz()
        {
         ...
         (p1==p6 && p6==p11 && p11==p16 && p16==p21 && p1!='n') ||       //pionowo
         (p2==p7 && p7==p12 && p12==p17 && p17==p22 && p2!='n') ||
         (p3==p8 && p8==p13 && p13==p18 && p18==p23 && p3!='n') ||
