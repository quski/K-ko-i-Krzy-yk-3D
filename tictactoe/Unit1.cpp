...
TForm1 *Form1;
  ...
  char p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27;
  //p1..p27 pola w grze (ich zawartosc: p1='n'; nic lub 'x' lub 'o' )
  char kto;
  int w_o=0;
  int w_x=0;
  int ruch, runda=1;
  ...
  void sprawdz()
  {
     ...
     if((p1==p2 && p2==p3 && p1!='n') ||
        ...
        (p1==p5 && p5==p9 && p1!='n') ||
        (p3==p5 && p5==p7 && p3!='n') ||
        (p10==p11 && p11==p12 && p10!='n') ||
        (p13==p14 && p14==p15 && p14!='n') ||
        (p16==p17 && p17==p18 && p17!='n') ||
        (p10==p13 && p13==p16 && p13!='n') ||
        (p11==p14 && p14==p17 && p11!='n') ||
        (p12==p15 && p15==p18 && p12!='n') ||
        (p10==p14 && p14==p18 && p10!='n') ||
        (p12==p14 && p14==p16 && p12!='n') ||
        (p19==p20 && p20==p21 && p19!='n') ||
        (p22==p23 && p23==p24 && p24!='n') ||
        (p25==p26 && p26==p27 && p27!='n') ||
        (p19==p22 && p22==p25 && p22!='n') ||
        (p20==p23 && p23==p26 && p23!='n') ||
        (p21==p24 && p24==p27 && p24!='n') ||
        (p19==p23 && p23==p27 && p19!='n') ||
        (p21==p23 && p23==p25 && p23!='n') ||
        (p1==p10 && p10==p19 && p1!='n') ||
        (p2==p11 && p11==p20 && p2!='n') ||
        (p3==p12 && p12==p21 && p3!='n') ||
        (p4==p13 && p13==p22 && p4!='n') ||
        ...
        char * w;
         switch(kto)
         {
                case 'x':
                        ...
                        w_o++;
                        if(w_o==3)
                         {   Application->MessageBox("Grê wygrywa kó³ko!", "Koniec gry", MB_OK);
                            w_o=0;
                            w_x=0;
                            runda=2;
                       ...
                       w_x++;
                       if(w_x==3)
                         {   Application->MessageBox("Grê wygrywa krzyzyk!", "Koniec gry", MB_OK);
                            w_o=0;
                            w_x=0;
                            runda=1;
                            Form1->FormCreate(Form1);
...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
    ...
    pole26->Picture->LoadFromFile("img/nic.bmp");
    pole27->Picture->LoadFromFile("img/nic.bmp");
    Image1->Picture->LoadFromFile("img/osmall.bmp");
    Image2->Picture->LoadFromFile("img/xsmall.bmp");
...
void __fastcall TForm1::pole26Click(TObject *Sender)
{
if(p26=='n')
   {
      if(kto=='o')
      {
         pole26->Picture->LoadFromFile("img/o.bmp");
         p26='o';
         kto='x';
         tura->Picture->LoadFromFile("img/xsmall.bmp");
      }
      ...
      {
         pole26->Picture->LoadFromFile("img/x.bmp");
         p26='x';
         kto='o';
         tura->Picture->LoadFromFile("img/osmall.bmp");
      }
      pole26->Enabled=false;
      sprawdz();
   }        
}
//---------------------------------------------------------------------------
...
if(p27=='n')
   {
      if(kto=='o')
      {
         pole27->Picture->LoadFromFile("img/o.bmp");
         p27='o';
         kto='x';
         tura->Picture->LoadFromFile("img/xsmall.bmp");
      }
      ...
      {
         pole27->Picture->LoadFromFile("img/x.bmp");
         p27='x';
         kto='o';
         tura->Picture->LoadFromFile("img/osmall.bmp");
      }
      pole27->Enabled=false;
      sprawdz();
   }
}
//---------------------------------------------------------------------------
